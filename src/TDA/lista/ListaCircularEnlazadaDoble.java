...
//            throw new ListaException("La lista está vacía");
    ...
    public void suprimir(Object elemento) throws ListaException {
        ...
        System.out.println("nodo " + isEmpty());
        if (isEmpty()) {
            anular();
        } else {
            fin.sgte = inicio;
    ...
    public boolean existe(Object elemento) throws ListaException {
        ...
        Agencia agencia = (Agencia)elemento;
        Nodo aux = inicio;
        Agencia agenciaTemp = (Agencia)aux.elemento;
        while (aux != fin) {
            agenciaTemp = (Agencia)aux.elemento;
            //if (aux.elemento.equals(elemento)) {
            if (agenciaTemp.getNombre().equalsIgnoreCase(agencia.getNombre()) ) {
                return true;
            }
            aux = aux.sgte;
        }//Se sale cuando apunta al último Nodo
        //return aux.elemento.equals(agencia);
        agenciaTemp = (Agencia)aux.elemento;
        return (agenciaTemp.getNombre().equalsIgnoreCase(agencia.getNombre()) );
    }
    ...
    public String toString() {
        ...
        String result = "LISTA DE AEROLINEAS\n\n";
        Nodo aux = inicio;
        while (aux != fin) {
            result += aux.elemento + "\n";
            aux = aux.sgte;
